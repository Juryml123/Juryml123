...
- **Auto-sync**: Projects added in editor appear in InterActiveResume.html
...
### InterActiveResume.html (Unchanged)
...
Store in localStorage['portfolioProjects']
    ↓
Main Portfolio (InterActiveResume.html)
    ↓
...
7. Open `InterActiveResume.html` and refresh
